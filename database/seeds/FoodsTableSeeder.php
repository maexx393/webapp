...
class FoodsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('foods')->insert(array (
            ...
            'ingredients' => '1/2 pound extra-lean ground beef1 egg, lightly beaten 2 tablespoons Italian-seasoned breadcrumbs1 tablespoon grated Parmesan cheese 2 tablespoons shredded fresh basil leaves1 tablespoon chopped Italian flat leaf parsley (optional) 2 green onions, sliced (',
                'weight' => 170.0,
                'featured' => 1,
                'restaurant_id' => 3,
                'category_id' => 3,
